...
import devkosta from "../public/dev-kosta-wave.png";
...
export default function Home() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <header>
        <title>Kostantino Reut Portfolio</title>
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className="min-h-screen">
          <nav className='py-10 mb-12 flex justify-between'>
            <h1 className='text-xl font-burtons dark:text-gray-300'>DevelopedByKosta</h1>
            <ul className='flex items-center'>
              <li>
                <BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className='cursor-pointer text-2xl dark:text-gray-300'/>
              </li>
              <li><a className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8 hover:to-teal-700' href="#">Resume</a></li>
            </ul>
          </nav>
          <div className='text-center p-10'>
            <h2 className='text-5xl py-2 text-teal-600 font-medium md:text-6xl'>Kostantino Reut</h2>
            <h3 className='text-2xl py-2 md:text-3xl dark:text-gray-300'>Developer and designer</h3>
            <p className='text-md py-5 leading-8 text-gray-800 dark:text-gray-300 md:text-lg max-w-xl mx-auto'>
              Freelancer providing services for programming and other needs. Join me down below and let's get cracking!
            </p>
          </div>
